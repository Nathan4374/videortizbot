...
token = "5391505930:AAEc6Q3Ne2VAjsNG8rSasUejijLzXks42mY"
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id,
                     "Hola, <strong> Vide0rtiz </strong> es un bot de tratamiento de vídeos. Estamos aquí para ayudarte a poder trabajar con tus vídeos en todas partes. Para ver todo lo que puedes hacer usa el comando /help", parse_mode="HTML")


# Listado de todas las opciones disponibles en el bot
@bot.message_handler(commands=['help'])
def send_help_message(message):
    helpMsg = """ Estas son todas las opciones disponibles en Vide0rtiz:
